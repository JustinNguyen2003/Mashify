...
def main():
    ...
    (segment_pdf1, segment_csv1) = sa.label_segment_boundaries(config_file, song1_stretched_dir)
    ...
    (segment_pdf2, segment_csv2) = sa.label_segment_boundaries(config_file, song2_stretched_dir)
